class DBConfig {
  ...
  static List<String> initQuery = [
    ...
    "CREATE TABLE memo (id INTEGER PRIMARY KEY AUTOINCREMENT, content TEXT, noticeDate TEXT, repeat TEXT DEFAULT 'none' NOT NULL,  FOREIGN KEY(repeat) REFERENCES repeat_cycle(code) )"
  ];
}
